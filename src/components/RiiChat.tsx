...
const QA = [
  ...
  {
    keywords: ["skill", "tools", "figma", "software", "use", "what can"],
    answer:
...
function getAnswer(input: string): string {
  ...
  return "I'm not sure about that — try asking about Riya's experience, skills, education, or projects like YouTube TV or Google.";
}
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: "#555", fontSize: "16px", padding: "6px",
          ...
          <button
            ...
            style={{
              background: "none", border: "none", cursor: "pointer",
              color: "#555", fontSize: "18px", padding: "6px",
              lineHeight: 1, transition: "color 0.15s",
              display: "flex", alignItems: "center",
            }}
            onMouseEnter={(e) => ((e.currentTarget as HTMLButtonElement).style.color = "#fff")}
                ...
                m.role === "bot" ? (
                  <div key={i} style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                    <div style={{
                      ...
                      justifyContent: "center", fontSize: "11px", marginTop: "2px",
                    }}>✦</div>
                    <p style={{
